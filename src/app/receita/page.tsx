...
export default function ReceitaPage() {
  ...
  const { totalReceitas, receitasMes, mediaReceitas, totalPages } = useCalcReceitas({ itens, meta });
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-green-50 border-green-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-green-800">Total de Receitas</CardTitle>
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-blue-800">Receitas do Mês</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-blue-600 mt-1">Referente ao mês atual </p>
              </CardContent>
            </Card>

            <Card className="bg-purple-50 border-purple-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-purple-800">Média por Receita</CardTitle>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {loading
                  ? 'Carregando...'
                  : `${meta.total} receita(s) encontrada(s)${debouncedBusca ? ` para "${debouncedBusca}"` : ''
                  }`}
                {errorMsg ? (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        ...
                        <Badge variant={r.status === 'Recebido' ? 'default' : 'secondary'} className="text-xs">
                          {r.status}
                        </Badge>
                      </div>
