...
export function useUltimasAtividades() {
        ...
        async function fetchUltimasAtividades() {
            try {
                ...
                const [receitasResponse, despesasResponse] = await Promise.all([
                    fetch("/api/receitaApi?page=1&pageSize=5&usuarioId=1"),
                    fetch("/api/despesaApi?page=1&pageSize=5&usuarioId=1"),
                ]);
